...
function App() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // const data = await response.json(); instead move straight to the source data
      
      // console.log(data);
      console.log(response.data.data);//"data key holds the array"
      setCatFacts(response.data.data); // "data" key holds the array of cat facts
    } catch (err) {
      console.error(err);
